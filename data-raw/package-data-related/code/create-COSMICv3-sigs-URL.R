COSMIC.v3.SBS96.sig.names <- colnames(COSMIC.v3.sigs$hg19$genome$SBS96)
...
COSMIC.v3.SBS192.sig.names <- colnames(COSMIC.v3.sigs$hg19$genome$SBS96)
...
COSMIC.v3.SBS192.sig.links <- 
  matrix(data = COSMIC.v3.SBS192.sig.urls, nrow = length(COSMIC.v3.SBS192.sig.urls), 
         dimnames = list(mSigAct:::AddMinusEFor192(COSMIC.v3.SBS192.sig.names), "URL"))
